...
@section('content')
    ...
    <div class="max-w-5xl mx-auto">
        ...
        {{-- Header --}}
        <div
            class="rounded-2xl border border-white/60 bg-gradient-to-tr from-indigo-500/15 via-indigo-300/10 to-transparent p-6">
        ...
        <div class="mt-4 grid gap-4 md:grid-cols-3">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach ($uk as $key => $val)
                                ...
                                @endphp
                                <span
                                    class="inline-flex items-center rounded-full bg-slate-50 px-3 py-1 text-xs ring-1 ring-slate-200">
            ...
            <div class="rounded-2xl border border-white/60 bg-white/80 backdrop-blur p-5 shadow-sm">
                ...
                @elseif($status === 'disetujui')
                    <p class="text-sm text-slate-600">
                        Pesanan telah disetujui. Silakan gunakan tombol <b>Lacak</b> untuk memantau proses produksi
